...
.log-form .forgot:hover {
  ...
  <h2>Uredi produkt</h2>
     <form:form method="POST" action="/SpringMVCCRUDSimple/editsave">  
       <form:hidden  path="id" />
       <form:input path="name" placeholder="ime" />
       <form:input path="salary" placeholder="cijena" />
       <form:input path="designation" placeholder="opis" /> 
    <button type="submit" class="btn">Uredi</button> 
       </form:form>  
